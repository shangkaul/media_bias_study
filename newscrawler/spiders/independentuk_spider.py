...
class IndependentUKSpider(SitemapSpider):
    name = "independent_uk_spider"
    ...
    custom_settings = {
        ...
        'LOG_LEVEL': 'DEBUG',
        'LOG_FILE': os.path.join(LOG_DIR, f'independent_uk_spider_{date}.log'),
        'LOG_FORMAT': '%(asctime)s [%(name)s] %(levelname)s: %(message)s',
        'FEEDS': {
            os.path.join(DATA_DIR, f'independent_uk_articles_{date}.json'): {
                'format': 'json',
                'encoding': 'utf8',
                'store_empty': False,
                'indent': 2
    ...
    SITE_CONFIG = {
        # article fields
        'title_path': '//h1[contains(@class, "sc-1xt8011-0")]/text()',
        'description_path' : '//h2[contains(@class, "sc-aeekvc-0")]//text()',
        'date_path': '//div[contains(@id, "article-published-date")]//text()',
        'author_path': '//a[starts-with(@href, "/author/")]//text()',
        'text_path': '//div[contains(@id, "main")]//text()'
    }
    ...
    def create_start_urls(self):
        ...
        base = 'https://www.independent.co.uk/sitemaps/sitemap-articles' 
    ...
    def __init__(self, *args, **kwargs):
        super(IndependentUKSpider, self).__init__(*args, **kwargs)
